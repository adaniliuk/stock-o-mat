...
(function() {
    ...
    StockMachine.AppView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.fetchQuotes();
            this.quotesIntervalId = window.setInterval(this.fetchQuotes, 60000); // 1 minute
            this.statsIntervalId = window.setInterval(this.updateStatistics, 5000, this); // 5 seconds
        },
